" Vim color file - fresh_modified
" Generated by http://bytefluent.com/vivify 2021-06-04
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "fresh_modified"

hi Normal guifg=#d6c0d6 guibg=#1a0e24 guisp=#1a0e24 gui=NONE ctermfg=182 ctermbg=235 cterm=NONE
...
hi LineNr guifg=#918891 guibg=#191024 guisp=#191024 gui=NONE ctermfg=246 ctermbg=235 cterm=NONE
...
hi PreProc guifg=#39db7f guibg=NONE guisp=NONE gui=NONE ctermfg=78 ctermbg=NONE cterm=NONE
...
hi Type guifg=#fa0563 guibg=NONE guisp=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
